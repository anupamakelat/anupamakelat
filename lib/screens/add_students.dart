// ignore_for_file: prefer_final_fields, prefer_const_constructors, sized_box_for_whitespace, deprecated_member_use, must_be_immutable, unnecessary_null_comparison

import 'dart:io';

import 'package:flutter/material.dart';
import 'package:getx_student_app/controller/student_controller.dart';
import 'package:getx_student_app/database/function.dart';
import 'package:getx_student_app/database/student.dart';
import 'package:getx_student_app/other/color.dart';
import 'package:getx_student_app/other/validator.dart';
import 'package:getx_student_app/screens/home.dart';
import 'package:getx_student_app/screens/student_list.dart';
  ...
  Future<void> submit(DateTime? db) async {
    ...
    if (_formKey.currentState?.validate() ?? false) {
      if (imagePath != null && dob != null) {
        ...
        Get.snackbar("Successful", "Student registered",colorText: Colors.black,backgroundColor: Color.fromARGB(255, 183, 217, 233));
